      ...
      <div className="py-[110px] bg-[url('/images/home-1/section-shape2.png')] bg-no-repeat bg-top bg-opacity-[0.07]">
        <div className="Container">
          ...
          >
            ...
            Enjoy a seamless stay with our top-tier facilities, including high-speed WiFi, complimentary breakfast, and 24/7 room service. For your security and convenience, all rooms feature smart card locks, ensuring a safe and comfortable experience.
            </p>
          </div>
