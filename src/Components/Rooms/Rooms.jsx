      ...
      <div className=" py-20 2xl:py-[120px] w-full bg-[url('/images/home-1/section-shape2.png')] bg-no-repeat bg-top bg-opacity-[0.07]">
        <div className="Container ">
          ...
          >
            ...
            Experience ultimate comfort in our elegantly designed rooms, featuring modern amenities and a cozy ambiance. Whether for business or leisure, enjoy a restful stay with top-tier hospitality.<br></br>
            Note: All our rooms are Double Suite Rooms.
            </p>
          </div>
