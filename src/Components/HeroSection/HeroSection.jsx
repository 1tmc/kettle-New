        ...
        <SwiperSlide>
          ...
          >
            <div className="font-Garamond 2xl:w-[720px] text-center">
              ...
              <h4 className="text-base mb-4">YOUR HOME</h4>
            ...
            <div className="w-[221px] h-[50px] border-white border hidden md:flex items-center justify-center absolute left-0 top-1/2 -rotate-90">
              <BiPhoneCall className="w-5 h-5 mr-2 text-khaki" /> +1 204 808 7512
            </div>
          </div>
        </SwiperSlide>
        {/* slider 2 */}
          ...
          >
            <div className="font-Garamond 2xl:w-[720px] text-center">
              ...
              <div className="mb-7 md:mb-8 lg:mb-9 xl:mb-10">
                ...
                119 RAILWAY AVE (W) GILLAM MB ROB OLO
                </h1>
              </div>
              <Link to={"/about"}>
                <button
            ...
            {/* contact info */}
            <div className="w-[221px] h-[50px] border-white border hidden md:flex items-center justify-center absolute left-0 top-1/2 -rotate-90">
              <BiPhoneCall className="w-5 h-5 mr-2 text-khaki" /> +1 204 939 0031
            </div>
          </div>
        </SwiperSlide>
        {/* slider 3 */}
